...
almacenamos información que no sea relevante, como las que autogeneran algunas
herramientas.
...
Escogemos este esquema de versionado porque es sencillo y se puede entender de forma intuitiva.
...
% Comprendemos quiénes son los usuarios objetivo del producto y cómo interacturarán
% con el sistema

\section{Definición del problema a resolver (definición de requisitos)}

% Explica que existen las HUs, pero que no las utilizamos por nuestra familiaridad
% con el campo
...
\section{Elección de solución}

% Relativamente trivial, explicamos un poco básicamente que tenemos que justificar
% el por qué de un sistema informático y más o menos cómo lo vamos a plantear.
